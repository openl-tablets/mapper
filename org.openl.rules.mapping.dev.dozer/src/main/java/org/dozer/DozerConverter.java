...
/**
 * This class should be extended in order to implement new Custom Converters for
...
public abstract class DozerConverter<A, B> implements ConfigurableCustomConverter {
    ...
    public Object convert(Object existingDestinationFieldValue,
        ...
        if (prototypeA.equals(wrappedDestinationClass)) {
            ...
            throw new MappingException("Destination Type (" + wrappedDestinationClass
                .getName() + ") is not accepted by this Custom Converter (" + this.getClass().getName() + ")!");
        }
