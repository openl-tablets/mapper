...
/**
 * Utility class to map from a Java 5 Type to the Class that is represented by
...
public final class TypeResolver {
    ...
    /**
     * Try to resolve the property type for the supplied methods and target
     * class. The supplied read and write methods should resemble a Java bean
     ...
     */
    public static Class<?> resolvePropertyType(final Class<?> targetClass,
    ...
    /**
     * returns an already cached [TypeVariable -> Type] map for the targetClass
     * or build a new one.
     */
