...
/**
 * Utility class to find methods that are bridged by other methods (bridge
 * methods)
 *
...
public final class BridgedMethodFinder {
    ...
    /**
     * Find the original method for the Java5 bridge Method. If the supplied
     * method is not a bridge method then the supplied method is returned. If
     * the supplied method is a bridge method, the algorithm tries to find a
     * more specific method with parameters and return types that can be
     * assigned to the the supplied method parameters and return type.
     *
     * Informally, method A is more specific than method B if any invocation
     * handled by method A can also be handled by method B.
     *
    ...
    /**
     * returns true if the supplied method can handle the invocation of the
     * candidate Method.
     *
     * @param candidate the method to inspect
     * @param method the proposed bridge method
     * @return true if the supplied method can handle the invocation of the
     *         candidate Method.
     */
    ...
    /**
     * Returns true if all the classes supplied as a's can be assigned to the
     * classes supplied as b's
     */
    ...
    /**
     * Returns true if all the class supplied as a can be assigned from b
     */
