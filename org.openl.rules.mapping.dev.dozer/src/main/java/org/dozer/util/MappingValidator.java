...
/**
 * Internal class used to perform various validations. Validates mapping
 * requests, field mappings, URL's, etc. Only intended for internal use.
 *
 * @author tierney.matt
...
public final class MappingValidator {
    ...
    public static URL validateURL(String fileName) {
        ...
        if (url == null) {
            MappingUtils
                .throwMappingException("Unable to locate dozer mapping file [" + fileName + "] in the classpath!");
        }
        ...
        try {
            ...
            if (stream != null) {
                try {
                    ...
                    MappingUtils
                        .throwMappingException("Unable to close input stream for dozer mapping file [" + url + "]");
                }
            }
        }
