 ...
 * <li>any objects that return a number of milliseconds applicable to
 * java.lang.Long format in their toString() form</li>
 * </ul>
 * </p>
 * <p/>
...
public class XMLGregorianCalendarConverter implements Converter {
    ...
    /**
     * Returns a new instance of DatatypeFactory, or the cached one if
     * previously created.
     *
