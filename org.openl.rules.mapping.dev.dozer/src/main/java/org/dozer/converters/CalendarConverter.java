...
/**
 * Internal class for converting Supported Data Types --> Calendar. Supported
 * source data types include Date, Calendar, String, Objects that return a long
 * from their toString(). Only intended for internal use.
 * 
 * @author tierney.matt
 */
