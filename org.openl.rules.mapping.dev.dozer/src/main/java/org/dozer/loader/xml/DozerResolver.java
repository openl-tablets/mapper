...
/**
 * Internal EntityResolver implementation to load Xml Schema from the dozer
 * classpath resp. JAR file.
 * 
 * <p>
 * Fetches "beanmapping.xsd" from the classpath resource "/beanmapping.xsd", no
 * matter if specified as some local URL or as
