...
/**
 * Public Spring FactoryBean that can be used by application code. Uses Spring
 * InitializingBean and DisposableBean contracts to properly start-up and
...
public class DozerBeanMapperFactoryBean implements FactoryBean, InitializingBean, DisposableBean {
    ...
    /**
     * Spring resources definition for providing mapping file location. Could be
     * used for loading all mapping files by wildcard definition for example
     * {@code
    ...
    /**
     * Spring DisposableBean method implemention. Triggered when application
     * context is stopped. Used to release global Dozer resources for hot
     * redeployment without stopping the JVM.
     *
     * @throws Exception
     */
