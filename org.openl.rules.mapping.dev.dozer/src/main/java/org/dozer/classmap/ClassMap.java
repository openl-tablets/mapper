 ...
 * information about a single class mapping. Only intended for internal use.
 * 
...
public class ClassMap {
    ...
    public FieldMap getFieldMapUsingDest(String destFieldName, boolean isMap) {
        ...
        for (FieldMap fieldMap : fieldMaps) {
            ...
            // name is used just in case the attribute was specified in the
            // dozer xml file starting in a Capital letter.
            // This prevents the field from getting double mapped in the case
            // that the class attr is named "field1" but in
            // the dozer xml is it specified as "Field1". This should never
