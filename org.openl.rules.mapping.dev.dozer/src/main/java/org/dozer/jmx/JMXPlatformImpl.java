...
/**
 *
 * Default JMX Platform implementation working with
...
public class JMXPlatformImpl implements JMXPlatform {
    ...
    public void registerMBean(String name, Object bean) throws MalformedObjectNameException,
    ...
    private void register(String name, Object bean, ObjectName mbeanObjectName) throws MBeanRegistrationException,
                                                                                NotCompliantMBeanException {
