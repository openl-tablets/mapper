...
public class PluginAdaptor {
    ...
    private PluginAdaptor(String jarpath,
        ...
        this.omitLogErrors = omitLogErrors;
    ...
    private List<BeanEntry> exportTypes(ModuleOpenClass openClass, URL[] jarURLs, ClassLoader cl) {
        ...
        classes.addAll(ClassUtils.loadClassesFromJars(jarURLs, cl, omitLogErrors));

        return ClassSerializer.serialize(classes, omitLogErrors);
    }
