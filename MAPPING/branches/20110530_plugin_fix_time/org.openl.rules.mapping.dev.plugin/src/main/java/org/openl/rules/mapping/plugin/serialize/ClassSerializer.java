...
public class ClassSerializer {
    ...
    public static BeanEntry serialize(Class<?> clazz, boolean omitLogErrors) {
        if (clazz == null) {
            return null;
        }
    ...
    public static List<BeanEntry> serialize(List<Class<?>> classes, boolean omitLogErrors) {
        List<BeanEntry> beans = new ArrayList<BeanEntry>(classes.size());

        for (Class<?> clazz : classes) {
            beans.add(serialize(clazz, omitLogErrors));
        }
