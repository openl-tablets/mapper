...
class CmdLineProcessor {
    ...
    private static final String OMIT_LOG_ERRORS_OPTION_LONG_NAME = "omit-log-errors";
    private static final String OMIT_LOG_ERRORS_OPTION_NAME = "ole";
    ...
    public CmdLineArgs parse(String[] args) {
        ...
        try {
            ...
            cmdArgs.setOmitLogErrors(commandLine.hasOption(OMIT_LOG_ERRORS_OPTION_NAME));
    ...
    private Options getCmdOptions() {
        ...
        if (cmdOptions == null) {
            ...
            Option omitLogErrors = OptionBuilder.withDescription("omit log errors")
                .withLongOpt(OMIT_LOG_ERRORS_OPTION_LONG_NAME)
                .create(OMIT_LOG_ERRORS_OPTION_NAME);
            ...
            cmdOptions.addOption(omitLogErrors);
