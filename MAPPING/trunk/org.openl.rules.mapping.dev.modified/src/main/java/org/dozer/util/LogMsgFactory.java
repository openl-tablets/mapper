...
public final class LogMsgFactory {
    ...
    public static String createFieldMappingErrorMsg(Object srcObj, FieldMap fieldMapping, Object srcFieldValue,
        ...
        if (srcFieldValue != null) {
            ...
            // 1797808 - If an error occurs calling src value toString(), eat
            // the error and still log the dozer error msg
            try {
                srcFieldValueString = srcFieldValue.toString();
            } catch (Exception e) {
                log.error("An exception occurred invoking toString() on the source field value: " + srcFieldValue
                    .getClass().getName() + "@" + Integer.toHexString(srcFieldValue.hashCode()), e);
